 ...
 function createPhotographerCard(data) {
    ...
    photographerArticle.innerHTML = `            
        ...
        <h3 class="photographerLocation" aria-label="Réside à ${city}, pays: ${country}" tabindex="0">${city}, ${country}</h3>
        <h3 class="photographerTagline" aria-label="Sa devise :${tagline}"  tabindex="0">${tagline}</h3>
        <h3 class="photographerPrice" aria-label="Tarif : ${price}€ par jour"  tabindex="0">${price}€/jour</h3>            
    `;      
 ...
 function createPhotographerBanner(data) {
    ...
    photographerBanner.innerHTML = `
        <div id="textsContentBox"  class="textsContentBox">
            ...
            <h2 class="photographerLocation" aria-label="Ville : ${city} , pays : ${country}" tabindex="0"> ${city}, ${country}</h2>
            <h2 class="photographerTagline" aria-label="slogan du photographe: ${tagline}" tabindex="0" aria-label="slogan du photographe:${tagline}">${tagline}</h2>            
        </div>       
